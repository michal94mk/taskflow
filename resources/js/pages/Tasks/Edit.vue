...
const form = useForm({
    ...
    task_status_id: String(props.task.task_status_id),
    task_priority_id: String(props.task.task_priority_id),
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            <div class="flex items-center gap-4">
                <Button variant="outline" size="icon" @click="$inertia.visit(`/tasks/${task.id}`)">
